...
int main(int argc, char *argv[])
{
	...
	return -1;
      ...
      std::cout << "Lock:" << rc << std::endl;
      std::cout << operations[0].sem_num  << std::endl;
      std::cout << operations[0].sem_op   << std::endl;
      std::cout << operations[0].sem_flg  << std::endl; 
      std::cout << operations[1].sem_num  << std::endl;
      std::cout << operations[1].sem_op   << std::endl;
      std::cout << operations[1].sem_flg  << std::endl; 
