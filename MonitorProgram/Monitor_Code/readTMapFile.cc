...
int main( int argc, char** argv ){
  ...
  TApplication* app     = new TApplication("DR230",&argc, argv);
  TMapFile* mapDr230    = TMapFile::Create("DR230.map");
  TMapFile* mapKeythley = TMapFile::Create("KEYTHLEY.map");
  ...
  bool isDrawn = false;
  TCanvas* can = new TCanvas("can","can1",1920,1000);
  TPad* pad[3];
