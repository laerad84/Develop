...
void setFilename(char *filename, time_t nowtime ){
  ...
  sprintf(filename, "/share/nfs/KEYTHLEY_CV_%04d_%02d_%02d.dat",(timeInfo->tm_year+1900),(timeInfo->tm_mon+1),timeInfo->tm_mday);
...
int main( int argc, char** argv)
{
  ...
  char    dev[256]="/dev/ttyS2";
   ...
   int    id;
   key_t  key;
   char   shmfilename[128] = "/home/koto/local/KOTO_MONITOR/shmkeythley_1.dat";
   ...
   */
   ...
   std::string com="TRAC:DATA:SEL? 0, 20";
